...
| P1-M04 Security Foundation                           | 🟡 CI-pending  | Crypto/keys, tokens, identity, RBAC/ABAC, sessions, auth engine, hash-chained audit, guard stack. In-sandbox gates green; on `feat/p1-m04-security-foundation` pending green CI (Prisma-gated API build). |
