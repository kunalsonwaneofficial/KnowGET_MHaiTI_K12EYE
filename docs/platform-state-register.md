...
> **Phase 2 — Enterprise Domain Engineering is CERTIFIED and frozen at `v0.3.0`
> (2026-07-29).** All 36 contracts merged and CI-green on `main`: thirty domains
> on one baseline, 225 tables (222 under FORCE RLS with a single canonical policy),
> 2,059 permission-gated REST routes, 704 domain event types, 41 migrations, and no
> domain package importing another. See
> `docs/certification/P2-Phase2-Certification-Report.md`.
...
Program: Workforce & Operations continues on the same certified `v0.2.0` baseline,
following the domain architecture pattern (ADR-0010):
...
| P2-D14 Fees, Finance & Payroll Platform                              | ✅ Complete | Money system of record — eight aggregates as `@knowget/financial` (ADR-0033), owning the compensation boundary P2-D03/P2-D12 deferred; money is integer minor units end to end. 8 RLS tables, 24 events, 71 routes. CI green; RLS verified on live PostgreSQL. Live on `main`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| P2-D15 Procurement, Inventory & Assets Platform                      | ✅ Complete | Resource system of record, the operational counterpart to Finance — eight aggregates as `@knowget/resource` (ADR-0034). 8 RLS tables, 22 events, 76 routes. CI green; RLS verified on live PostgreSQL. Live on `main`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| P2-D16 Smart Mobility, Transport & Fleet Platform                    | ✅ Complete | Transport system of record — eight aggregates as `@knowget/transport` (ADR-0035); owns a vehicle as an operating unit where P2-D15 owns it as depreciating capital. 8 RLS tables, 26 events, 71 routes. CI green; RLS verified on live PostgreSQL. Live on `main`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| P2-D17 Residential Life, Hostel & Boarding Platform                  | ✅ Complete | Boarding system of record — eight aggregates as `@knowget/residential` (ADR-0036). 8 RLS tables, 30 events, 65 routes. CI green; RLS verified on live PostgreSQL. Live on `main`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| P2-D18 Knowledge Resource, Library & Digital Learning Asset Platform | ✅ Complete | Library system of record — catalog, copies, licensed digital assets, members, loans, reservations and circulation policy — eight aggregates as `@knowget/library` (ADR-0037). 8 RLS tables, 29 events, 69 routes. CI green; RLS verified on live PostgreSQL. Live on `main`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |

Program: Campus & Engagement builds on the now-complete operational base,
following the domain architecture pattern (ADR-0010):

| Contract                                                              | Status      | Notes                                                                                                                                                                                                                                                                                                                                   |
| --------------------------------------------------------------------- | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P2-D19 Integrated Health Centre & Clinical Services Platform          | ✅ Complete | Operational clinical system of record — centres and clinicians, appointments, encounters, prescriptions, sick-bay admissions and referrals — eight aggregates as `@knowget/health-centre` (ADR-0038). 8 RLS tables, 37 events, 73 routes. CI green; RLS verified on live PostgreSQL. Live on `main`.                                    |
| P2-D20 Campus Infrastructure, Facilities & Smart Environment Platform | ✅ Complete | Built-environment system of record — buildings and spaces, infrastructure systems, sensors and append-only environment readings, maintenance work and comfort policy — eight aggregates as `@knowget/facilities` (ADR-0039). 8 RLS tables, 36 events, 70 routes. CI green; RLS verified on live PostgreSQL. Live on `main`.             |
| P2-D21 Campus Security, Safety & Visitor Platform                     | ✅ Complete | Physical-security system of record — zones, visitors and visits, access credentials with an append-only access log, incidents and emergency drills — eight aggregates as `@knowget/campus-security` (ADR-0040). 8 RLS tables, 44 events, 81 routes. CI green; RLS verified on live PostgreSQL. Live on `main`.                          |
| P2-D22 Unified Communication, Engagement & Collaboration Platform     | ✅ Complete | Engagement system of record — audiences, announcements with immutable acknowledgement receipts, threads and messages, surveys and immutable responses — eight aggregates as `@knowget/engagement` (ADR-0041). 8 RLS tables, 32 events, 52 routes. CI green; RLS verified on live PostgreSQL. Live on `main`.                            |
| P2-D23 Admissions, Marketing, Enrollment & Growth Platform            | ✅ Complete | Admissions system of record — campaigns and leads, admission cycles with per-grade seat plans, applications, immutable entrance evaluations, offers and enrollment confirmations — eight aggregates as `@knowget/admissions` (ADR-0042). 8 RLS tables, 35 events, 61 routes. CI green; RLS verified on live PostgreSQL. Live on `main`. |
| P2-D24 Alumni, Community & Relationship Platform                      | ✅ Complete | Alumni-network system of record — profiles, chapters and memberships, events and registrations, mentorship connections and the immutable giving record — eight aggregates as `@knowget/alumni` (ADR-0043). 8 RLS tables, 37 events, 58 routes. CI green; RLS verified on live PostgreSQL. Live on `main`.                               |

Program: Intelligence Core (D25–D30) builds on the complete operational base
D01–D24, following the domain architecture pattern (ADR-0010):

| Contract                                                                                   | Status      | Notes                                                                                                                                                                                                                                                                                                                                                             |
| ------------------------------------------------------------------------------------------ | ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P2-D25 Institutional Knowledge Graph, Semantic Intelligence & Digital Memory               | ✅ Complete | The semantic layer and digital memory — six aggregates as `@knowget/knowledge-graph` (ADR-0044); every assertion carries an evidence chain. 6 RLS tables, 20 events, 38 routes. CI green; RLS verified on live PostgreSQL. Live on `main`.                                                                                                                        |
| P2-D26 Enterprise AI Operating System, Agent Orchestration & Reasoning                     | ✅ Complete | The AI runtime — six aggregates plus five pure engines as `@knowget/agent-orchestration` (ADR-0045); agents invoke capabilities by key, never databases, behind a single-use human gate. 6 RLS tables, 37 events, 85 routes. CI green; RLS verified on live PostgreSQL. Live on `main`.                                                                           |
| P2-D27 Institutional Decision Intelligence, Workflow Orchestration & Autonomous Operations | ✅ Complete | The decision layer — six aggregates plus six pure engines as `@knowget/decision-intelligence` (ADR-0046); an ungrounded recommendation is refused at construction. 6 RLS tables, 41 events, 84 routes. CI green; RLS verified on live PostgreSQL. Live on `main`.                                                                                                 |
| P2-D28 Predictive Intelligence, Simulation & Strategic Planning                            | ✅ Complete | The prediction layer that the twenty-four operational domains deferred their forecasting to — seven aggregates as `@knowget/predictive-intelligence` (ADR-0047); an undeclared forecast cannot be built. 7 RLS tables, 30 events, 77 routes. CI green; RLS verified on live PostgreSQL. Live on `main`.                                                           |
| P2-D29 Executive Intelligence, Governance & Institutional Command                          | ✅ Complete | The command layer — seven aggregates as `@knowget/executive-intelligence` (ADR-0048); a missing pillar is excluded, never zeroed, and coverage travels beside the score. 7 RLS tables, 32 events, 69 routes. CI green; RLS verified on live PostgreSQL. Live on `main`.                                                                                           |
| P2-D30 Platform Evolution, Institutional Learning & Continuous Improvement                 | ✅ Complete | How the institution changes itself on purpose, and the last of Phase 2's thirty-six — seven aggregates plus eight pure engines as `@knowget/platform-evolution` (ADR-0049); human governance with no override path, and lessons resolved only by the P2-D25 graph. 7 RLS tables, 39 events, 66 routes. CI green; RLS verified on live PostgreSQL. Live on `main`. |

Phase-2 certification closes the phase:
...
| P3-D02 Event Mesh, Streaming & Messaging | 🟡 CI red   | The second spine contract — eight aggregates plus eight pure engines as `@knowget/event-mesh` (ADR-0051); it governs the traffic rather than carrying it, so `@knowget/events` still owns the bus and the outbox. A published event type cannot be edited, a stream cannot activate without a carrying binding, and a replay needs a second person. 8 RLS tables (three partial uniques), 35 events, 82 routes, 856 package tests. Merged to `main` (`29e5ee6`), but CI is red on `@knowget/database:typecheck` — `@prisma/client` resolves to a module exporting neither `Prisma` nor `PrismaClient` after a `prisma generate` that reported success. Under investigation. |
