import type { OrganizationDirectory, PersonDirectory } from "@knowget/admissions";
...
/**
 * {@link PersonDirectory} backed by the person service (P2-D01-M02). An application's applicant is a Person;
 * the directory answers existence so the domain validates them without duplicating the person record. The
 * prospect/applicant/student lifecycle records are Student Lifecycle's (P2-D03), referenced by id.
 */
