import type { OrganizationDirectory, PersonDirectory } from "@knowget/engagement";
...
/**
 * {@link PersonDirectory} backed by the person service (P2-D01-M02). An announcement author, a thread
 * participant and a survey respondent are Persons; the directory answers existence so the domain validates
 * them without duplicating the person record. (Audience membership is held opaquely and not per-item
 * validated — the organization is the anchor.)
 */
