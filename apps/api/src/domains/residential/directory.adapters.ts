 ...
 * `organizationOf` resolves the employee's organization so a warden derives its org from the staff member
 * it links to — the employee is never duplicated here.
 */
 ...
 * from the student it serves — the student is never duplicated here.
 */
